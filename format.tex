...
\sem{n}%which semester
\coursename{name of course}%name of course
\ccode{coursecode}%course code
\type{EndSem}%endsem or midsemm
\season{Winter}%winter, fall, summer, etc.
\batch{2013-14}% batch 2013-14,2014-15,2015-16 etc

\profname{name of prof}%name of prof
